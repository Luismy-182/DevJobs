<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @can('create', App\Models\Vacante::class)    {{--puedes usar el can o el if para ocultar zonas que no pertencen al usuario pero si al admin--}}
                     <!-- Navigation Links -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @if (auth()->user()->rol===2)
                    ...
                    class="mr-2 w-7 h-7  flex justify-center items-center  font-extrabold"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @auth
            ...
            @if (auth()->user()->rol===2)
                    <a href="{{route('notificaciones')}}"
                    class="'block w-full pl-3 pr-4 py-2 border-l-4 border-transparent text-left text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800" 
                    >
